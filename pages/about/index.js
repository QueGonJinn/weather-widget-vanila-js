			...
			<div class="temp__daytime">
                            <div class="day__wrapper">
                                    <span class="day__name">${
																			days[new Date(this.daily * 1000).getDay()]
																		}</span>
                                    <span class="day__number">${new Date(
																			this.daily * 1000,
																		).getDate()}</span>
                                    <span class="day__month">${
																			month[new Date(this.daily * 1000).getMonth()]
																		}</span>
                            </div>
                            <div class="daytime_wrapper">
                                    <div class="current__temperature">
                                            <div class="currentday__temperature-wrapper">
                                                    <span class="day__time">День: </span>
                                                    <span class="day__temp">${
																											this.dayTemp > 0
																												? `+${Math.round(this.dayTemp)}`
																												: Math.round(this.dayTemp)
																										}</span>
                                            ...
                                            <div class="currentday__temperature-wrapper">
                                                    <span class="day__time">Ночь: </span>
                                                    <span class="day__temp">${
																											this.nightTemp > 0
                    ...
                    <div class="day__additions">
                            <div class="additions__item">
                                    <div id="daytime__clouds" class="item__param">Облачность:</div>
                                    <div id="daytime__clouds__param" class="item__meaning">${
																			this.clouds
																		} %</div>
                            </div>
                            <div class="additions__item">
                                    <div id="daytime__humidity" class="item__param">Влажность:</div>
                                    <div id="daytime__humidity__param" class="item__meaning">${
																			this.humidity
																		} %</div>
                            </div>
                            <div class="additions__item">
                                    <div id="daytime__wind" class="item__param">Ветер:</div>
                                    <div id="daytime__wind__param" class="item__meaning">${
																			Math.round(this.wind * 10) / 10
																		} м/с</div>
                            </div>
                            <div class="additions__item">
                            ...
                            <div class="additions__item">
                                    ...
                                    <div id="daytime__pressure__param" class="item__meaning">${
																			this.pressure
																		} мм.рт.ст</div>
                            </div>
                            <div class="additions__item add_sunrise">
                                    <div id="daytime__sunrise" class="item__param">Восход - Закат: </div>
                                    <div id="daytime__sunrise__param" class="item__meaning">
                                            ${new Date(this.sunrise * 1000).getHours()}:${new Date(
			this.sunrise * 1000,
		).getMinutes()}
                    </div>
                    <span> - </span>
                    <div id="daytime__sunset__param" class="item__meaning">
